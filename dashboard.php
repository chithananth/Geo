    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          <h1 class="logo me-auto me-lg-0"><i class="fa fa-space-shuttle" aria-hidden="true"></i>&nbsp;Geologist</a></h1>
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
             ...
             <!----- <li><a class="nav-link scrollto" href="#">News</a></li>--->
              <li><a class="nav-link scrollto" href="#service">Resources</a></li>
              <li><a class="nav-link scrollto" href="#universe">Universe</a></li>
            </ul>
            <i class="bi bi-list mobile-nav-toggle"></i>
          </nav><!-- .navbar -->
          
          <p style="font-size:100%;margin-top:1%;margin-right:-15%;color:white;"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo "$user";?></p>
          &nbsp;
          <a href="index.php" style="float:right;"><i class="fa fa-sign-out" aria-hidden="true" style="font-size:100%;"></i>&nbsp;&nbsp;Logout</a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8">
          ...
          <a href="https://youtu.be/kOEDG3j1bjs?si=Ru3dWge3ywmERXTL" class="glightbox play-btn mb-4"></a>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              <div class="card-img">
               <a href="remote.html"> <img src="assets/img/remote sensing2.jpg" alt="" class="img-fluid"></a>
              </div>
              <h3><a href="service-details.html" class="link">Remote Sensing</a></h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              <div class="card-img">
              <a href="about.html">  <img src="assets/img/sar_data.jpg" alt="" class="img-fluid" ></a>
              </div>
              <h3><a href="service-details.html" class="link">SAR Data</a></h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="card">
              <div class="card-img">
               <a href="ARSET - Nasa.html"><img src="assets/img/arset.jpg" alt="" class="img-fluid"></a> 
              </div>
              <h3><a href="service-details.html" class="link">ARSET</a></h3>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="social-links">
        ...
        <a href="#" class="instag
        ram"><i class="bx bxl-instagram"></i></a>
